...
var css = [
	...
	"	color: rgba(52, 123, 255, .5) !important;;",
	"}",
	...
	"	font-size: 16px !important;",
	"}",
	".infobox, .mbox-small, .navbox, .quotebox, .thumb, .tright, .toccolours {",
	"	border: 1px solid #eee !important;",
	...
	"}",
	"sub, sup {",
	"	line-height: .1em; /* prevents sub/superscripts from throwing off line spacing */",
	"}",
	"/* title */",
	".firstHeading {",
	...
	"}",
	"#toc a:active { color: #222 !important;",
	"	outline: none;",
	"}",
	"/* hide protected lock */",
